        ...
        <div className="container mx-auto">
          <div className="max-w-[800px] mx-auto">
            ...
            <p className="text-lg text-dark-100 mb-8">
              Choose your role to begin a coding interview session
            </p>
            ...
            <div className="flex gap-6">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md border border-neutral-200 w-1/2 flex flex-col">
                ...
                <p className="text-dark-100 mb-4 flex-grow">
                  Create a session. You'll be able to select problems
                </p>
                <button 
                  onClick={startAsInterviewer}
                  className="w-full py-3 rounded-md bg-primary text-light font-bold"
                >
              ...
              <div className="bg-white p-6 rounded-lg shadow-md border border-neutral-200 w-1/2 flex flex-col">
                ...
                <p className="text-dark-100 mb-4 flex-grow">
                  Join a session and solve coding problems. You'll wait for an interviewer to
                  select a problem for you.
                </p>
                <button 
                  onClick={startAsInterviewee}
                  className="w-full py-3 rounded-md bg-primary text-light font-bold"
                >
            ...
            <div className="mt-8 p-6 bg-white rounded-lg shadow-md border border-neutral-200">
              ...
              <div className="flex gap-2">
                ...
                />
                <button className="px-6 py-2 bg-primary text-light font-bold rounded-md">
                  Join
                </button>
              </div>
            </div>
