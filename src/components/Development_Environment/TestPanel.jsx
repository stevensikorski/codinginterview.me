...
export default function UnitTestPanel() {
  ...
  return (
    <div className="flex flex-col flex-grow h-full bg-neutral-950 text-neutral-300 overflow-hidden">
        ...
        <div className="flex items-center">
          <button
            ...
            className={`flex items-center gap-1 px-3 py-1 rounded-md text-sm font-medium ${
              runningTests
                ? "bg-neutral-700 text-neutral-400 cursor-not-allowed" //disabled style when tests are running
                : "bg-[#EB5528] text-white hover:bg-[#EB5528]/90" //normal style
            }`}
          >
            <Play size={14} />
